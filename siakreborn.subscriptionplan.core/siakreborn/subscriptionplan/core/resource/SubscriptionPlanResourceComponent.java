...
public abstract class SubscriptionPlanResourceComponent implements SubscriptionPlanResource{
    ...
    public abstract SubscriptionPlan createSubscriptionPlan(VMJExchange vmjExchange);
	public abstract SubscriptionPlan createSubscriptionPlan(VMJExchange vmjExchange, int id);    
